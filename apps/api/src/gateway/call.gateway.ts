...
export class CallGateway implements OnGatewayConnection, OnGatewayDisconnect {
  ...
  handleConnection(client: Socket) {
    console.log(`⚡ Baby step successful! Device connected to gateway socket id: ${client.id}`);
  }
  ...
  handleAgentAcceptance(
    ...
    console.log(`🟢 [ANSWER] Agent picked up the call for patient socket line: ${data.patientSocketId}`);
