...
const tiers: Tier[] = [
  {
    ...
    price: "৳1,490",
    cadence: "/ month",
    blurb: "Essential coverage for individuals seeking routine telehealth access.",
    features: [
      "2 home consultations per month",
      "Prescription delivery support",
      "24/7 medical chat access",
  ...
  },
  {
    ...
    price: "৳3,290",
    cadence: "/ month",
    blurb: "Expanded coverage for families and chronic-condition management.",
    features: [
      "6 home consultations per month",
      "Priority dispatch (≤ 10 min)",
      "Specialist video referrals",
  ...
  },
  {
    ...
    price: "৳5,990",
    cadence: "/ month",
    blurb: "Comprehensive care for households with full diagnostic access.",
    features: [
      "Unlimited home consultations",
      "Portable diagnostic dispatch",
      "Dedicated family physician",
      "Nutritionist + specialist roster",
      "Emergency geofence coverage",
      "Concierge medical concierge",
    ],
  },
];
