...
export default function NutritionistDashboard() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-8 bg-slate-50 min-h-screen">
      {/* Header Banner */}
      <div>
        <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Nutritionist Clinical Workspace</h1>
        <p className="text-sm text-slate-500 mt-1">Manage patient medical diets, log anthropometric progress, and issue medical charts.</p>
      </div>
